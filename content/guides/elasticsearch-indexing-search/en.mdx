...
<Callout type="info">
📚 **What is Indexing?** Indexing is the process of storing documents in a database. Elasticsearch uses an inverted index to store and quickly search JSON documents.
</Callout>
...
<Callout type="tip">
💡 **Field Types**: `text` is for full-text search (word analysis), `keyword` is for exact matches.
</Callout>
...
curl -X POST http://localhost:9200/products/_doc \
  ...
  -d '{
    ...
    "in_stock": true,
    "description": "High-performance laptop, 8-core processor, 16GB RAM"
  }'
</CopyBlock>
...
✅ **Congratulations!** You can now index and search data in Elasticsearch.
</Callout>
